const INFO = {
	...
	homepage: {
		...
		description:
			"I am a front-end web developer with proficiency in Node.js, specializing in creating secure and scalable applications. Seeking to enhance my skills in back-end development and AWS to become an end-to-end expert.",
	},
	...
	projects: [
		...
		{
			title: "Wedding Invitation Project",
			description:
				"My first project, a MPA wedding invitation website that elegantly presents couple details gallert and manages RSVP.",
			logo: ["https://cdn.jsdelivr.net/npm/programming-languages-logos@0.0.3/src/html/html.png","https://cdn.jsdelivr.net/npm/programming-languages-logos@0.0.3/src/css/css.png","https://cdn.jsdelivr.net/npm/programming-languages-logos/src/javascript/javascript.png"],
			linkText: "View code on Git Hub",
